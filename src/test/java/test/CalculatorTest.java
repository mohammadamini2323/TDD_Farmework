...
public class CalculatorTest {
    ...
    @Test
    public void sum2(){
        Assertions.assertEquals(7,Calculator.sum(3,4),"fails");

    }
    @Test
    public  void sum3(){
        Assertions.assertEquals(24,Calculator.sum(8,8,8),"FALSE");

    }
    @Test
    public void division(){
        Assertions.assertEquals(4,Calculator.division(24,6),"fails");
    }
    @Test
    public void division2(){
        Assertions.assertEquals(4,Calculator.division(4,1),"fails");
    }
}
